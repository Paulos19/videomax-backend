...
export function ChatPanel({
  ...
  return (
    <div className="w-full lg:w-[400px] flex flex-col h-full bg-room-surface/80 backdrop-blur-xl border-l border-room-border rounded-none lg:rounded-2xl overflow-hidden shrink-0">
      {/* Header */}
      <ChatHeader
