...
export function RoomStandby3DView({
  ...
  return (
    <div className="relative w-full h-full min-h-[360px] bg-[#050508] flex items-center justify-center overflow-hidden select-none">
      ...
      <div className="relative z-10 max-w-lg mx-auto p-6 text-center space-y-5 bg-[#09090D]/85 border border-[#222] backdrop-blur-md shadow-2xl">
        ...
        <div className="flex items-center justify-center gap-2">
          <span
            className={cn(
              ...
              isPro
                ? 'bg-[#1E1408] border-[#FFE600]/50 text-[#FFE600]'
        ...
        <div className="space-y-1">
          ...
          <p className="text-[11px] font-mono text-[#888] max-w-md mx-auto leading-relaxed">
            {canControl
          ...
          <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
            {onShareScreen && (
              <button
                ...
                className={cn(
                  ...
                  isPro
                    ? 'bg-[#FFE600] hover:bg-white text-black shadow-[0_0_20px_rgba(255,230,0,0.35)]'
                    : 'bg-[#FF5A00] hover:bg-white text-black shadow-[0_0_20px_rgba(255,90,0,0.35)]'
                )}
              >
            ...
            {onSelectVideo && (
              <button
                ...
                className="px-4 py-2.5 bg-[#121218] hover:bg-[#1C1C24] text-white border border-[#333] hover:border-[#FF5A00] font-mono font-bold text-[10px] uppercase tracking-wider transition-colors flex items-center gap-2 cursor-pointer"
              >
            ...
            {onOpenLibrary && (
              <button
                ...
                className="px-4 py-2.5 bg-[#121218] hover:bg-[#1C1C24] text-white border border-[#333] hover:border-[#FFE600] font-mono font-bold text-[10px] uppercase tracking-wider transition-colors flex items-center gap-2 cursor-pointer"
              >
                <FolderOpen className="w-3.5 h-3.5 text-[#FFE600]" />
                <span>MINHA BIBLIOTECA</span>
              </button>
            )}
          </div>
        ) : (
          <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#121218] border border-[#333] text-[#AAA] font-mono text-[10px] uppercase">
